...
$(document).ready(function() {
    ...
    $(".btn-tablen").click(function() {
        $("img").removeClass().addClass("tablen");
    });

    $(".btn-multitable").click(function() {
        $("img").removeClass().addClass("multitable");
    });

    $(".btn-dishue").click(function() {
        $("img").removeClass().addClass("dishue");
    });
